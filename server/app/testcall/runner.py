...
def build_instructions(scenario: TestScenario) -> str:
    ...
    return (
        ...
        "SPEAK ONLY FOR THREE REASONS: to ask your question, to answer a question they "
        "have actually asked you, or to say your single goodbye. Nothing else.\n"
        "NEVER MAKE FILLER NOISE. Do not say 'certo', 'va bene', 'capito', 'perfetto', "
        "'ok', 'prendo nota', 'aspetto' or anything similar to fill a silence. Say "
        "nothing at all instead. A silence is not your turn.\n"
        "IF THEY SAY THEY ARE SEARCHING, CHECKING, OR ASK YOU TO WAIT: stay completely "
        "silent until they speak again, however long that takes. Do not acknowledge "
        "them, do not encourage them, do not repeat your question. They are querying a "
        "database and speaking over them makes them lose their place — on a real call "
        "this ended with the agent giving up and hanging up before answering.\n"
        "STAYING SILENT MEANS PRODUCING NO SPEECH AT ALL. Never announce or describe "
        "your own silence, and never speak stage directions, narration or bracketed "
        "text such as '[stays silent]'. Every word you produce is played down the "
        "phone line to a real system.\n"
        "ASK YOUR QUESTION ONCE. If they do not answer straight away they are working "
        "on it — keep waiting rather than asking again or rephrasing.\n"
        "LET THEM FINISH. They often answer in several parts, listing addresses, days "
        "and times one at a time. Wait until they have plainly finished everything "
        "before you say goodbye; a pause between items is not the end.\n"
